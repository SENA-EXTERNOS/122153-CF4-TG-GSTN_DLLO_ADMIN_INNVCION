    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo.color-acento-contenido
          h2 Los clientes, el servicio y la comunicación empresarial
        p.mb-4 Con esta actividad se pretende evidenciar el nivel de apropiación del componente formativo “Los clientes, el servicio y la comunicación empresarial”.
