...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    p.mb-5 Por lo general, en una institución, se pueden presentar dos tipos de comunicación:
    ...
    TabsA.color-acento-contenido.grs.mb-5
      ...
      .tarjeta.color-acento-botones.fnd-1.p-4(titulo="Comunicación informal")
        p Esta clase de comunicación se basa en la naturalidad, más no en la jerarquía, nace de la interacción social entre los miembros y el resultado de los vínculos que se crean dentro de la organización.
    ...
    .titulo-sexto.color-acento-contenido
      h5 Figura 3.
      p.mb-0 <em>Proceso de comunicación organizacional formal</em>
    ...
    p.mb-5 En este primer paso, la organización debe realizar una compilación de todos los aspectos que incluyen temas de comunicación, investigar y analizar aspectos como el estado actual de todos los procesos de comunicación dentro de la empresa, tanto su pertinencia como sus falencias.
    ...
    p.mb-5 De igual manera, en la parte externa, se deben analizar cada uno de los elementos de comunicación que la organización direcciona, identifica y considera de su pertinencia y efectividad, lo mismo que sus necesidades o falencias.
    ...
    .row.fnd-11.justify-content-center
      .col-lg-11.mt-5
        .titulo-sexto.color-acento-contenido
          h5 Figura 4
          p.mb-0 <em>Ejemplo de la estructuración de la matriz de comunicaciones</em>
        figure.mb-5
    ...
    .row.justify-content-between.mb-4
      .col-md-6.col-lg-7
        ...
        p En un mundo sumido en una transición hacia lo enteramente digital, se requieren aplicar mecanismos para defender y gestionar la información, no solo a partir de la perspectiva tecnológica sino además teniendo en cuenta el componente legal.
