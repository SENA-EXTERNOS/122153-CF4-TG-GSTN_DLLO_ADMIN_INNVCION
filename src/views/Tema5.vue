...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    figure.mb-5
      .video
        iframe(width="560" height="315" src="https://www.youtube.com/embed/EH43cJNW86s" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    h3(data-aos="fade-right").mb-4
      ...
      |Normativa en tiempos de respuesta

    p No existe una regla que determine cuándo y cómo, debe proporcionarse una respuesta al cliente, sobre un producto o servicio.

    p.mb-5 Pero sí podemos aportar algunas recomendaciones que serán útiles, para aplicar en cualquier organización:
